...
- ~~**備援影片沒錄**~~ — ✅ 2026-08-02 已錄：<https://www.youtube.com/watch?v=MTC7J2y4nyQ>
  「說說學伴決賽demo」，4:45，權限是**不公開（unlisted）**——已用未登入的瀏覽器
  實測載得出播放器，現場任何裝置憑連結都放得出來（若設成「私人」就會要求登入，
  那才是會出事的設定）。
  **仍建議先下載一份離線檔**：現場網路是手機熱點，串流 YouTube 可能卡頓，
  而備援影片卡住就沒有第二層備援了。
- **6 分鐘 demo 沒有完整計時過**——現在是唯一沒有 plan B 的環節。影片 4:45，
  若全程改播影片，剩約 75 秒給開場與 Q&A。腳本在 memory 的
